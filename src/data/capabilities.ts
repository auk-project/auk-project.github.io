        ...
        samples: [
          {
            ...
            instruction: "Say the following in the voice described here: “A visionary, complex warlord of an era in turmoil, speaking in a slightly husky but penetrating middle-aged male voice. Confident and decisive in tone, with a keen, penetrating read on people. Marked rhythmic shifts — first lowering his voice to set the stage slowly, then suddenly stressing the key words. Both heroic grandeur and an undercurrent of menace and suspicion”",
          ...
          },
          {
            ...
            lang: "zh",
            label: "Instruct TTS · Mandarin",
            instruction: "Say the following in the voice described here: “A middle-aged woman confronting, face to face, the person who abandoned her years ago — pouring out three decades of suppressed hatred and grievance in a husky, dried-out voice, as if her tears had long run dry. Slow, steady pacing, every word crisp and icy; moderate-to-low overall volume, yet the voice trembles faintly with suppressed sobbing at the moments of resentment. A desolate, weathered timbre with real force, line endings carrying a bone-deep resolve, and the final sentence suddenly rising, hurled out with almost her whole remaining strength”",
          ...
          },
          {
            ...
            instruction: "Say the following in the voice described here: “A classic Shakespearean villain savoring the moment just before unveiling the truth. A rich, theatrically charged baritone with full chest resonance; unhurried pacing with deliberate pauses and emphases; consonants rolled with exaggeration, diction crisp and staged. The tone feigns sweetness, almost doting, then snaps cold between the words — sharp as a blade, every syllable laced with dangerous, delighted smugness”",
          ...
          },
          {
            ...
            lang: "en",
            label: "Instruct TTS · English",
            instruction: "Say the following in the voice described here: “As if delivering devastating news at a funeral — a soft, choked voice forcing back tears, speech breaking between pauses, each word heavier than the last, the final line torn open by grief, trembling with a sob that can no longer be held down. Slow, low intonation with unsteady breath; clarity slightly eroded by the choking. The overall mood is solemn and mournful”",
        ...
        samples: [
          {
            ...
            instruction: "Keep the words and change the timbre to: “The speaker has a low, rich, resonant voice with steady pacing and crisp articulation. His delivery is composed and thoughtful, carrying a quiet, reflective quality.”",
            audio: {
          ...
          },
          {
            ...
            lang: "zh",
            label: "Voice Edit · Mandarin",
            instruction: "Keep the words and change the timbre to: “The speaker is a female voice, clear and bright in timbre, with steady pacing and very precise articulation. Her style is formal and objective, in the manner of a news broadcast or the reading of an official document.”",
            audio: {
          ...
          },
          {
            ...
            instruction: "Keep the words and change the timbre to: “The speaker has a clean, limpid voice with a noticeable British accent. Slow-paced, sincere and frank in tone, in the style of someone calmly recounting personal experience. The timbre is warm and soothing, articulation crisp and clean, intonation calm and unhurried, creating the atmosphere of a story quietly told.”",
            audio: {
